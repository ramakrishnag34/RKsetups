...
aws s3api create-bucket --bucket rkccit987456.k8s.local --region us-east-1
aws s3api put-bucket-versioning --bucket rkccit987456.k8s.local --region us-east-1 --versioning-configuration Status=Enabled
